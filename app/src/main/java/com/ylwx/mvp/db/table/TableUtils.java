...
import com.ylwx.mvp.db.annotation.Table;
...
public class TableUtils {
     ...
     * key: entityType.name
     */
    private static ConcurrentHashMap<String, com.ylwx.mvp.db.table.Id> entityIdMap = new ConcurrentHashMap<String, com.ylwx.mvp.db.table.Id>();

    /* package */
    static synchronized com.ylwx.mvp.db.table.Id getId(Class<?> entityType) {
        ...
        com.ylwx.mvp.db.table.Id id = new com.ylwx.mvp.db.table.Id(entityType, primaryKeyField);
        entityIdMap.put(entityType.getName(), id);
        return id;
    }

    private static String getPrimaryKeyFieldName(Class<?> entityType) {
        com.ylwx.mvp.db.table.Id id = getId(entityType);
